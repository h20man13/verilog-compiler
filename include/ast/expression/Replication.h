...
private:
	Expression* const times; //the number of times the expression should be replicated
...
public:
	 ...
	 */
	Replication(const Position& position, Expression* const times, Expression* const exp);
