...
class OutputRegScalarDeclaration: public RegScalarDeclaration{
public:
	OutputRegScalarDeclaration(const Position& position, std::list<RegValue* const> &reg_list, SymbolTable* const table);
