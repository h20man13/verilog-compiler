...
#ifndef SYSTEMTASKCALL_H
#define SYSTEMTASKCALL_H
 ...
 * @author Jacob Bauer
 */
class SystemTaskCall: public TaskCall{
public:
	...
	SystemTaskCall(const Position& position, const std::string& function_name, const std::list<Expression* const> &param_list);

	/**
	 * The copy constructor is used to copy a System function call
	 * @param func  the function that will be coppied
	 */
	SystemTaskCall(const SystemTaskCall& func);
