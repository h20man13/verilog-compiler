...
\begin{center}
\leavevmode
\includegraphics[height=6.000000cm]{d4/dbe/classOutputWireVectorDeclaration}
\end{center}
\end{figure}
\doxysubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{classOutputWireVectorDeclaration_a09c3090528a7d63c6e843928cea0c57d}\label{classOutputWireVectorDeclaration_a09c3090528a7d63c6e843928cea0c57d}} 
{\bfseries Output\+Wire\+Vector\+Declaration} (const \mbox{\hyperlink{classPosition}{Position}} \&position, \mbox{\hyperlink{classConstantExpression}{Constant\+Expression}} $\ast$const start, \mbox{\hyperlink{classConstantExpression}{Constant\+Expression}} $\ast$const end, std\+::list$<$ \mbox{\hyperlink{classIdentifier}{Identifier}} $\ast$const $>$ \&ident\+\_\+list, \mbox{\hyperlink{classSymbolTable}{Symbol\+Table}} $\ast$const table)
\item 
